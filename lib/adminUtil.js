...
const ModelHandler_1 = require("./v4/model/ModelHandler");
class AdminUtil {
    /**
    ...
    static getModel(name) {
        ...
        let model = ModelHandler_1.ModelHandler.model.get(name.toLowerCase());
        if (!model) {
            adminizer.log.error(`No model found [${name}] in sails.`);
            return null;
        }
        return model;
    }
