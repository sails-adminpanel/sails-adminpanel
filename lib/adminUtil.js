...
class AdminUtil {
     ...
     * @private
     */
    static _isValidEntityConfig(config) {
     ...
     * @private
     */
    static _normalizeEntityConfig(config) {
     ...
     * @returns {?Object}
     */
    static findEntityConfig(req, entityName) {
        if (!this.config().entities || !this.config().entities[entityName]) {
     ...
     * @returns {?Model}
     */
    static findModel(req, entityConfig) {
 ...
 */
AdminUtil._defaultEntityConfig = {
    list: true,
    add: true,
    edit: true,
    remove: true,
