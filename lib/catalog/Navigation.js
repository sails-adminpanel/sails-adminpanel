...
class Navigation extends AbstractCatalog_1.AbstractCatalog {
    constructor(config) {
        ...
        for (const configElement of config.items) {
            items.push(new NavigationItem(configElement.title, configElement.model, config.model, configElement.urlPath));
        }
...
class NavigationItem extends AbstractCatalog_1.AbstractItem {
    ...
    async getAddHTML(loc) {
        ...
        return {
            type: type,
            data: ejs.render(fs.readFileSync(viewsHelper_1.ViewsHelper.getViewPath('./../../views/ejs/navigation/itemHTMLAdd.ejs'), 'utf8'), {
                items: items,
    ...
    async getEditHTML(id, catalogId, loc, modelId) {
        ...
        return Promise.resolve({
            type: type,
            data: ejs.render(fs.readFileSync(viewsHelper_1.ViewsHelper.getViewPath('./../../views/ejs/navigation/itemHTMLEdit.ejs'), 'utf8'), { item: item, __: __ })
        });
    }
...
class NavigationGroup extends AbstractCatalog_1.AbstractGroup {
    ...
    getAddHTML(loc) {
        ...
        return Promise.resolve({
            type: type,
            data: ejs.render(fs.readFileSync(viewsHelper_1.ViewsHelper.getViewPath('./../../views/ejs/navigation/GroupHTMLAdd.ejs'), 'utf8'), {
    ...
    async getEditHTML(id, catalogId, loc, modelId) {
        ...
        return Promise.resolve({
            type: type,
            data: ejs.render(fs.readFileSync(viewsHelper_1.ViewsHelper.getViewPath('./../../views/ejs/navigation/GroupHTMLEdit.ejs'), 'utf8'), {
                fields: this.groupField,
                item: item,
                __: __
            }),
...
class LinkItem extends NavigationGroup {
    ...
    getAddHTML(loc) {
        ...
        return Promise.resolve({
            type: type,
            data: ejs.render(fs.readFileSync(viewsHelper_1.ViewsHelper.getViewPath('./../../views/ejs/navigation/LinkItemAdd.ejs'), 'utf8'), { __: __ }),
        });
    }
    async getEditHTML(id, catalogId, loc) {
        let type = 'html';
        let item = await this.find(id, catalogId);
        this.i18n.setLocale(loc);
        const __ = (s) => {
        ...
        return Promise.resolve({
            type: type,
            data: ejs.render(fs.readFileSync(viewsHelper_1.ViewsHelper.getViewPath('./../../views/ejs/navigation/LinkItemEdit.ejs'), 'utf8'), {
                fields: this.groupField,
                item: item,
                __: __
            }),
