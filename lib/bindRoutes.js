...
class Router {
    ...
    static bind() {
         ...
         * Widgets All
         */
        sails.router.bind(`${config.routePrefix}/widgets-get-all`, bindPolicies_1.default(policies, widgetHandler_1.getAllWidgets));
        /**
         * Widgets All from DB
         */
        sails.router.bind(`${config.routePrefix}/widgets-get-all-db`, bindPolicies_1.default(policies, widgetHandler_2.widgetsDB));
        /**
         * Widgets Switch
         */
        sails.router.bind(`${config.routePrefix}/widgets-switch/:widgetId`, bindPolicies_1.default(policies, switch_1.widgetSwitchController));
        /**
         * Widgets Info
         */
        sails.router.bind(`${config.routePrefix}/widgets-info/:widgetId`, bindPolicies_1.default(policies, Info_1.widgetInfoController));
        /**
         * Widgets Action
         */
        sails.router.bind(`${config.routePrefix}/widgets-action/:widgetId`, bindPolicies_1.default(policies, Action_1.widgetActionController));
        /**
         * Widgets Custom
         */
        sails.router.bind(`${config.routePrefix}/widgets-action/:widgetId`, bindPolicies_1.default(policies, Custom_1.widgetCustomController));
        /**
         * Migrations
         * */
        if (config.globalSettings.enableMigrations) {
            sails.router.bind(`${config.routePrefix}/migrations`, bindPolicies_1.default(policies, migrations_1.default));
            sails.router.bind(`${config.routePrefix}/processMigrations`, bindPolicies_1.default(policies, processMigrations_1.default));
        }
        /**
         * Install Stepper
         * */
        sails.router.bind(`${config.routePrefix}/processInstallStep`, bindPolicies_1.default(policies, processInstallStep_1.default));
        sails.router.bind(`${config.routePrefix}/processInstallFinalize`, bindPolicies_1.default(policies, processInstallFinalize_1.default));
        /**
         * Edit form
         * */
         ...
         */
        sails.router.bind(`${baseRoute}/ckeditor5/upload`, bindPolicies_1.default(policies, ckeditorUpload_1.default));
        /**
...
__decorate([
    utils_decorators_1.debounce(5000)
], Router, "bind", null);
