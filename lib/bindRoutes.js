...
var _dashboard = require('../actions/dashboard').default();
var _welcome = require('../actions/welcome');

var _list = require('../actions/list').default();
var _list_json = require('../actions/listJson').default();
var _edit = require('../actions/edit').default();
var _add = require('../actions/add').default();
