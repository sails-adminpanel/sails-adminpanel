...
class Router {
    ...
    static bind() {
         ...
         * Catalog get Items
         */
        sails.router.bind(`${config.routePrefix}/get-catalog`, (0, bindPolicies_1.default)(policies, Catalog_1.getCatalogItems));
        /**
         * Migrations
         * */
         ...
         * Install Stepper
         * */
        sails.router.bind(`${config.routePrefix}/processInstallStep`, (0, bindPolicies_1.default)(policies, processInstallStep_1.default));
        sails.router.bind(`${config.routePrefix}/processInstallFinalize`, (0, bindPolicies_1.default)(policies, processInstallFinalize_1.default));
        /**
         * Edit form
         * */
