            ...
            if (this.checkFieldAccess(fieldConfig.config)) {
                ...
                // Handle association-many
                    ...
                    if (Array.isArray(fieldValue)) {
                        ...
                        sails.log.error(`Expected array for association-many field: ${fieldConfig.model.model}.${fieldKey}, but got:`, fieldValue);
                    }
                }
                ...
                // Log an error for unexpected scenarios
                    ...
                    sails.log.error(`Unexpected field configuration or value for: ${fieldConfig.model.model}.${fieldKey}`);
                }
            }
        }
