...
export declare class Waterline<T> extends AbstractModel<T> {
    ...
    protected findOne(id: string | number): Promise<T | null>;
    protected find(criteria?: Partial<T>): Promise<T[]>;
    protected updateOne(id: string | number, data: Partial<T>): Promise<T | null>;
    protected update(criteria: Partial<T>, data: Partial<T>): Promise<T[]>;
    protected destroyOne(id: string | number): Promise<T | null>;
