...
function bindMediaManager() {
    sails.after(["hook:orm:loaded"], async () => {
        try {
            ...
            let mediaManager2 = new DefaultMediaManager_1.DefaultMediaManager('test', 'media-manager2', `${process.cwd()}/.tmp/public/media-manager2/`);
            MediaManagerHandler_1.MediaManagerHandler.add(mediaManager2);
        }
        catch (e) {
