...
async function bindAuthorization() {
    ...
    sails.router.bind(baseRoute + '/login', bindPolicies_1.default(policies, login_1.default));
    sails.router.bind(baseRoute + '/logout', bindPolicies_1.default(policies, login_1.default));
}
