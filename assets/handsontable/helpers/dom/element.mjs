...
import { hasCaptionProblem, isClassListSupported, isTextContentSupported, isGetComputedStyleSupported } from "../feature.d.ts";
import { isSafari, isIE9 } from "../browser.d.ts";
import { sanitize } from "../string.d.ts";
/**
