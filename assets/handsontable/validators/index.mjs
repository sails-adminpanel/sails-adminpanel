...
import { registerValidator } from "./registry.d.ts";
/**
...
export { getRegisteredValidatorNames, getRegisteredValidators, getValidator, hasValidator, registerValidator } from "./registry.d.ts";
