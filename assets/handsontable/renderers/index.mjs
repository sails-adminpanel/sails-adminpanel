...
import { registerRenderer } from "./registry.d.ts";
/**
...
export { getRegisteredRendererNames, getRegisteredRenderers, getRenderer, hasRenderer, registerRenderer } from "./registry.d.ts";
