...
import { createObjectPropListener, getProperty, isObject, objectEach, setProperty } from "./helpers/object.d.ts";
import { countFirstRowKeys as _countFirstRowKeys } from "./helpers/data.d.ts";
