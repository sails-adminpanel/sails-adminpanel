...
import { arrayEach, arrayFilter, arrayReduce, arrayMap } from "../../helpers/array.d.ts";
import { cancelAnimationFrame, requestAnimationFrame } from "../../helpers/feature.d.ts";
import GhostTable from "../../utils/ghostTable.mjs";
import Hooks from "../../pluginHooks.d.ts";
import { isObject, hasOwnProperty } from "../../helpers/object.d.ts";
import { valueAccordingPercent, rangeEach } from "../../helpers/number.d.ts";
import SamplesGenerator from "../../utils/samplesGenerator.mjs";
import { isPercentValue } from "../../helpers/string.d.ts";
