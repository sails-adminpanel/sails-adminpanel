...
import { registerEditor } from "../editors/registry.d.ts";
import { registerRenderer } from "../renderers/registry.d.ts";
import { registerValidator } from "../validators/registry.d.ts";
