...
import { registerCellType } from "./registry.d.ts";
/**
...
export { getCellType, getRegisteredCellTypeNames, getRegisteredCellTypes, hasCellType, registerCellType } from "./registry.d.ts";
