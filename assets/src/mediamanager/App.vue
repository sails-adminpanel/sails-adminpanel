<template>
	<div class="flex flex-col gap-4">
		<span>Загрузка галереи изображений:</span>
		<div class="flex gap-2">
			...
			<div>132132</div>
			<div>132132</div>
			<div class="w-[34px] h-[34px] flex justify-center items-center bg-gray-300 cursor-pointer hover:bg-gray-400 transition" @click="openPopup">
